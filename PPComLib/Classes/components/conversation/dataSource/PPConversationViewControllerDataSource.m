...
@interface PPConversationViewControllerDataSource ()

@property (nonatomic) NSMutableArray *messageList;

@end

@implementation PPConversationViewControllerDataSource
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.conversationViewController = self.viewController;
