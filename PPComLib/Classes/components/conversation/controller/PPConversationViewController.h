//
//  PPConversationBaseViewController.h
//  PPMessage
//
...
@class PPConversationItem, PPMessage, PPMessageItemBaseView;

@interface PPConversationViewController : UIViewController <UITableViewDelegate>
