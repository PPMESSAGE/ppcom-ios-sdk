...
extern CGFloat const PPConversationViewTextViewBaseLineHeight;

@class PPConversationViewInputToolbar;

@protocol PPConversationViewInputToolbarDelegate <NSObject>

@optional
- (void)didHeightChanged:(PPConversationViewInputToolbar*)inputToolbar
...
@property (nonatomic, weak) id<PPConversationViewInputToolbarDelegate> inputToolbarDelegate;
