...
#import "PPConversationViewController+PPVoiceMessage.h"
...
#import "PPConversationViewControllerKeyboardDelegate.h"
...
- (void)dealloc {
    ...
    self.conversationView.inputToolbar.inputToolbarDelegate = nil;
    self.conversationView.inputToolbar.textInputView.delegate = nil;
...
- (void)endEditing {
    [self.conversationView endEditing:YES];
}
...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView {
    [self.conversationView.inputToolbar.textInputView resignFirstResponder];
}
...
- (PPVoiceRecordHelper*)voiceRecordHelper {
    if (!_voiceRecordHelper) {
        ...
        _voiceRecordHelper.maxTimeStopRecorderCompletion = ^{
            ...
            UIButton *holdDown = weakSelf.conversationView.inputToolbar.holdToTalkButton;
...
- (void)registerCellClass {
    PPConversationViewMessages *conversationViewMessages = self.conversationView.conversationViewMessages;
    // Register classes
    // (incoming)
    [conversationViewMessages registerClass:[PPMessageItemLeftTextView class] forCellReuseIdentifier:PPMessageItemLeftTextViewIdentifier];
    [conversationViewMessages registerClass:[PPMessageItemLeftImageView class] forCellReuseIdentifier:PPMessageItemLeftImageViewIdentifier];
    [conversationViewMessages registerClass:[PPMessageItemLeftFileView class] forCellReuseIdentifier:PPMessageItemLeftFileViewIdentifier];
    [conversationViewMessages registerClass:[PPMessageItemLeftLargeTxtView class] forCellReuseIdentifier:PPMessageItemLeftLargeTxtViewIdentifier];
    [conversationViewMessages registerClass:[PPMessageItemLeftVoiceView class] forCellReuseIdentifier:PPMessageItemLeftVoiceViewIdentifier];
    [conversationViewMessages registerClass:[PPMessageItemLeftUnknownView class] forCellReuseIdentifier:PPMessageItemLeftUnknownViewIdentifier];
    
    // (outgoing)
    [conversationViewMessages registerClass:[PPMessageItemRightTextView class] forCellReuseIdentifier:PPMessageItemRightTextViewIdentifier];
    [conversationViewMessages registerClass:[PPMessageItemRightImageView class] forCellReuseIdentifier:PPMessageItemRightImageViewIdentifier];
    [conversationViewMessages registerClass:[PPMessageItemRightFileView class] forCellReuseIdentifier:PPMessageItemRightFileViewIdentifier];
    [conversationViewMessages registerClass:[PPMessageItemRightLargeTxtView class] forCellReuseIdentifier:PPMessageItemRightLargeTxtViewIdentifier];
