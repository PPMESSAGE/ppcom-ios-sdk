...
@interface PPConversationViewControllerKeyboardDelegate ()
...
@implementation PPConversationViewControllerKeyboardDelegate
...
- (void)scrollToBottomAnimated:(BOOL)animated
    ...
    CGFloat diffHeight = MAX(0, self.inputToolbar.bounds.size.height - PPConversationViewTextViewBaseLineHeight);
