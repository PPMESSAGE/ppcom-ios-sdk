...
CGFloat const PPConversationViewTextViewBaseLineHeight = 42;
...
- (void)pp_init {
    ...
    self.textViewHeight = PPConversationViewTextViewBaseLineHeight;
}
...
- (void)didLineNumberChangedWith:(NSUInteger)lineNumber
    ...
    if (lineNumber <= self.maxLineNumber) {
        ...
        CGFloat textViewLineHeight = PPConversationViewTextViewBaseLineHeight + (lineNumber - 1) * composeTextView.font.lineHeight;
...
- (CGRect)positionForHoldToTalkButton {
    ...
    CGFloat height = PPConversationViewTextViewBaseLineHeight - PPTextInputViewPadding * 2;
