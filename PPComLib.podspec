...
Pod::Spec.new do |s|
  s.name             = 'PPComLib'
  s.version          = '0.1.0'
  s.summary          = 'A short description of PPComLib.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/PPComLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'PPMessage' => 'kun.zhao@yvertical.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/PPComLib.git', :tag => s.version.to_s }
